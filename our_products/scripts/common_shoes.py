...
# file names
files = {
    "amazon":   "amazon_shoes.csv",
    "flipkart": "flipkart_shoes.csv",
    "myntra":   "myntra_shoes.csv",
}
...
# Set matching threshold (you can adjust this for stricter/looser matching)
threshold = 62
...
output_path = os.path.join(BASE_PATH, "common_shoes.csv")
